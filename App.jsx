...
},
{
  ...
  id: 231,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'zajeżdżanie / rozpoczęcie pracy pod jeźdźcem'?",
  options: ["breaking-in", "starting in riding", "saddle beginning", "rider training start"],
  correctIndex: 0,
  explanation: "'Breaking-in' oznacza 'zajeżdżanie / rozpoczęcie pracy pod jeźdźcem'.",
},
{
  id: 232,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'praca pod siodłem'?",
  options: ["ridden work", "saddle training", "horse riding process", "mounted practice"],
  correctIndex: 0,
  explanation: "'Ridden work' oznacza 'pracę pod siodłem'.",
},
{
  id: 233,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'intensywny trening'?",
  options: ["strong training", "intensive training", "hard horse work", "heavy schooling"],
  correctIndex: 1,
  explanation: "'Intensive training' oznacza 'intensywny trening'.",
},
{
  id: 234,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'dojrzałość układu kostnego'?",
  options: ["bone readiness", "skeletal maturity", "full bone growth", "skeleton balance"],
  correctIndex: 1,
  explanation: "'Skeletal maturity' oznacza 'dojrzałość układu kostnego'.",
},
{
  id: 235,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'dojrzewanie kręgosłupa'?",
  options: ["spinal maturation", "spine growth", "backbone maturity", "vertebral development"],
  correctIndex: 0,
  explanation: "'Spinal maturation' oznacza 'dojrzewanie kręgosłupa'.",
},
{
  id: 236,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'kostnienie'?",
  options: ["hardening", "ossification", "bone setting", "calcifying growth"],
  correctIndex: 1,
  explanation: "'Ossification' oznacza 'kostnienie'.",
},
{
  id: 237,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'płytki wzrostowe'?",
  options: ["growth plates", "bone plates", "growing joints", "young bone lines"],
  correctIndex: 0,
  explanation: "'Growth plates' oznacza 'płytki wzrostowe'.",
},
{
  id: 238,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'stabilizacja mięśniowa'?",
  options: ["muscle support", "muscular stabilization", "body stabilization", "topline control"],
  correctIndex: 1,
  explanation: "'Muscular stabilization' oznacza 'stabilizację mięśniową'.",
},
{
  id: 239,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'kompromis'?",
  options: ["middle choice", "compromise", "balance point", "shared option"],
  correctIndex: 1,
  explanation: "'Compromise' oznacza 'kompromis'.",
},
{
  id: 240,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'przeciążenie'?",
  options: ["pressure", "overload", "strain up", "too much work"],
  correctIndex: 1,
  explanation: "'Overload' oznacza 'przeciążenie'.",
},
{
  id: 241,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'przetrenowanie'?",
  options: ["overtraining", "too much training", "horse burnout", "training overload"],
  correctIndex: 0,
  explanation: "'Overtraining' oznacza 'przetrenowanie'.",
},
{
  id: 242,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'zwyrodnienia stawów / artroza'?",
  options: ["joint disease", "degenerative joint disease", "joint weakness", "bone stiffness"],
  correctIndex: 1,
  explanation: "'Degenerative joint disease' oznacza 'zwyrodnienia stawów / artrozę'.",
},
{
  id: 243,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'chipy kostne'?",
  options: ["bone chips", "bone pieces", "joint fragments", "small bone breaks"],
  correctIndex: 0,
  explanation: "'Bone chips' oznacza 'chipy kostne'.",
},
{
  id: 244,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'urazy kostne'?",
  options: ["bone injuries", "skeletal trauma", "bone damage", "hard tissue injuries"],
  correctIndex: 0,
  explanation: "'Bone injuries' oznacza 'urazy kostne'.",
},
{
  id: 245,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'kulawizna'?",
  options: ["uneven movement", "lameness", "limping horse", "bad gait"],
  correctIndex: 1,
  explanation: "'Lameness' oznacza 'kulawiznę'.",
},
{
  id: 246,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'zapadnięty grzbiet'?",
  options: ["hollow back", "arched back", "weak topline", "sagging spine"],
  correctIndex: 1,
  explanation: "'Hollow back' lub 'sway back' oznacza 'zapadnięty grzbiet'.",
},
{
  id: 247,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'trwałe odkształcenia'?",
  options: ["permanent deformities", "lasting changes", "hard deforming", "body distortions"],
  correctIndex: 0,
  explanation: "'Permanent deformities' oznacza 'trwałe odkształcenia'.",
},
{
  id: 248,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'odcinek lędźwiowy'?",
  options: ["lumbar region", "lower back bone", "loin area", "back section"],
  correctIndex: 0,
  explanation: "'Lumbar region' oznacza 'odcinek lędźwiowy'.",
},
{
  id: 249,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'weterynarz'?",
  options: ["horse doctor", "veterinarian", "equine medic", "animal therapist"],
  correctIndex: 1,
  explanation: "'Veterinarian' oznacza 'weterynarza'.",
},
{
  id: 250,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'fizjoterapeuta koński'?",
  options: ["horse physio", "equine physiotherapist", "equine therapist", "animal movement doctor"],
  correctIndex: 1,
  explanation: "'Equine physiotherapist' oznacza 'końskiego fizjoterapeutę'.",
},
{
  id: 251,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'osteopata koński'?",
  options: ["equine osteopath", "horse osteotherapist", "equine bone therapist", "horse mobility doctor"],
  correctIndex: 0,
  explanation: "'Equine osteopath' oznacza 'końskiego osteopatę'.",
},
{
  id: 252,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'badanie RTG / prześwietlenie'?",
  options: ["radiograph", "X-ray", "scan photo", "bone picture"],
  correctIndex: 1,
  explanation: "'X-ray' oznacza 'badanie RTG / prześwietlenie'.",
},
{
  id: 253,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'ocena gotowości do treningu'?",
  options: ["training check", "readiness assessment", "work readiness test", "young horse review"],
  correctIndex: 1,
  explanation: "'Readiness assessment' oznacza 'ocenę gotowości do treningu'.",
},
{
  id: 254,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'dopasowanie siodła'?",
  options: ["saddle fit", "saddle fitting", "saddle adjustment", "saddle position"],
  correctIndex: 1,
  explanation: "'Saddle fitting' oznacza 'dopasowanie siodła'.",
},
{
  id: 255,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'niedopasowany sprzęt'?",
  options: ["bad tack", "ill-fitting tack", "wrong tack", "poor equipment fit"],
  correctIndex: 1,
  explanation: "'Ill-fitting tack' oznacza 'niedopasowany sprzęt'.",
},
{
  id: 256,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'kontrolne wizyty'?",
  options: ["re-checks", "check-ups", "follow-up checks", "repeat visits"],
  correctIndex: 1,
  explanation: "'Check-ups' oznacza 'kontrolne wizyty'.",
},
{
  id: 257,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'padokowanie / wypuszczanie na padok'?",
  options: ["field time", "turnout", "outside release", "free paddock work"],
  correctIndex: 1,
  explanation: "'Turnout' oznacza 'padokowanie / wypuszczanie na padok'.",
},
{
  id: 258,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'schłodzenie po pracy'?",
  options: ["cooling off", "cool-down", "rest down", "after-work release"],
  correctIndex: 1,
  explanation: "'Cool-down' oznacza 'schłodzenie po pracy'.",
},
{
  id: 259,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'chętny do pracy'?",
  options: ["trainable", "willing", "forward", "motivated"],
  correctIndex: 1,
  explanation: "'Willing' oznacza 'chętny do pracy'.",
},
{
  id: 260,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'gorący' (o koniu)?",
  options: ["reactive", "nervous", "hot", "forward-going"],
  correctIndex: 2,
  explanation: "'Hot' oznacza konia 'gorącego', łatwo nakręcającego się.",
},
{
  id: 261,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'uparty'?",
  options: ["dominant", "stubborn", "lazy", "pushy"],
  correctIndex: 1,
  explanation: "'Stubborn' oznacza 'uparty'.",
},
{
  id: 262,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'towarzyski / przyjazny ludziom'?",
  options: ["friendly", "people-oriented", "social", "all are correct"],
  correctIndex: 3,
  explanation: "'People-oriented' oznacza 'towarzyski / przyjazny ludziom'.",
},
{
  id: 263,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'wałach'?",
  options: ["stallion", "gelding", "colt", "mare"],
  correctIndex: 1,
  explanation: "'Gelding' oznacza 'wałacha'.",
},
{
  id: 264,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'ogier'?",
  options: ["stallion", "colt", "gelding", "stud colt"],
  correctIndex: 0,
  explanation: "'Stallion' oznacza 'ogiera'.",
},
{
  id: 265,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'źrebiczka'?",
  options: ["foal", "filly", "mare", "colt"],
  correctIndex: 1,
  explanation: "'Filly' oznacza 'źrebiczkę'.",
},
{
  id: 266,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'WKKW'?",
  options: ["event riding", "eventing", "combined riding", "three-phase sport"],
  correctIndex: 1,
  explanation: "'Eventing' oznacza 'WKKW'.",
},
{
  id: 267,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'jazda w terenie'?",
  options: ["trail riding", "hacking", "country riding", "outdoor schooling"],
  correctIndex: 1,
  explanation: "'Hacking' oznacza 'jazdę w terenie'.",
},
{
  id: 268,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'powożenie'?",
  options: ["carriage sport", "driving", "horse driving", "cart work"],
  correctIndex: 1,
  explanation: "'Driving' oznacza 'powożenie'.",
},
{
  id: 269,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'koń gorącokrwisty typu sportowego'?",
  options: ["thoroughbred", "warmblood", "sport horse", "hotblood"],
  correctIndex: 1,
  explanation: "'Warmblood' oznacza konia gorącokrwistego typu sportowego.",
},
{
  id: 270,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'koń pełnej krwi angielskiej'?",
  options: ["arabian", "thoroughbred", "purebred", "blood horse"],
  correctIndex: 1,
  explanation: "'Thoroughbred' oznacza konia pełnej krwi angielskiej.",
},
{
  id: 271,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'mieszaniec'?",
  options: ["crossbred", "mixed-breed", "grade horse", "all of the above"],
  correctIndex: 3,
  explanation: "W zależności od kontekstu można użyć 'crossbred', 'mixed-breed' albo 'grade horse'.",
},
{
  id: 272,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'krzyżowanie ras'?",
  options: ["linebreeding", "crossbreeding", "outcrossing", "mix breeding"],
  correctIndex: 1,
  explanation: "'Crossbreeding' oznacza 'krzyżowanie ras'.",
},
{
  id: 273,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'kojarzenie w linii'?",
  options: ["linebreeding", "inbreeding", "outcrossing", "controlled crossing"],
  correctIndex: 0,
  explanation: "'Linebreeding' oznacza 'kojarzenie w linii'.",
},
{
  id: 274,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'outcross' / łączenie niepokrewnionych linii?",
  options: ["inbreeding", "linebreeding", "outcrossing", "cross matching"],
  correctIndex: 2,
  explanation: "'Outcrossing' oznacza łączenie niepokrewnionych linii.",
},
{
  id: 275,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'eksterier / budowa'?",
  options: ["build", "conformation", "type", "frame"],
  correctIndex: 1,
  explanation: "'Conformation' oznacza 'eksterier / budowę'.",
},
{
  id: 276,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'długi grzbiet'?",
  options: ["long back", "long-backed", "weak topline", "deep back"],
  correctIndex: 1,
  explanation: "'Long-backed' oznacza 'długi grzbiet'.",
},
{
  id: 277,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'wysoki kłąb'?",
  options: ["high withers", "sharp withers", "tall neck base", "high topline"],
  correctIndex: 0,
  explanation: "'High withers' oznacza 'wysoki kłąb'.",
},
{
  id: 278,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'słaba linia grzbietu / słaby topline'?",
  options: ["weak topline", "poor back", "hollow topline", "soft spine"],
  correctIndex: 0,
  explanation: "'Weak topline' oznacza 'słabą linię grzbietu'.",
},
{
  id: 279,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'mocny zad'?",
  options: ["good hind end", "strong hindquarters", "strong quarters", "powerful croup"],
  correctIndex: 1,
  explanation: "'Strong hindquarters' oznacza 'mocny zad'.",
},
{
  id: 280,
  type: "word",
  prompt: "Jak powiedzieć po angielsku: 'postawa kończyn / ustawienie nóg'?",
  options: ["stance", "leg alignment", "1 and 2 are correct", "leg setting"],
  correctIndex: 2,
  explanation: "W słowniczku pojawia się 'stance / leg alignment'.",
},
{
  id: 281,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Nie powinniśmy zaczynać zajeżdżania zbyt wcześnie.'",
  options: [
    "We shouldn’t start backing too early.",
    "We must not begin horse riding work in too early age.",
    "Do not start under-rider too soonly.",
    "We should avoid making first saddle before."
  ],
  correctIndex: 0,
  explanation: "To dokładnie naturalna forma podana w słowniczku.",
},
{
  id: 282,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Praca pod siodłem powinna pasować do poziomu konia.'",
  options: [
    "Ridden work should match the horse’s level.",
    "Saddle work must fit to horse stage.",
    "The work under saddle should be same like the horse.",
    "Horse riding work has to be on horse age levelly."
  ],
  correctIndex: 0,
  explanation: "To poprawne i naturalne zdanie ze słowniczka.",
},
{
  id: 283,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Intensywny trening w wieku 2–3 lat może być ryzykowny.'",
  options: [
    "Intensive training at 2–3 can be risky.",
    "Strong training in age two or three is danger.",
    "At 2–3 the horse can risk by much training.",
    "Training intensive on young age has more dangerly."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
{
  id: 284,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Koń potrzebuje wystarczającej dojrzałości układu kostnego.'",
  options: [
    "The horse needs enough skeletal maturity.",
    "The horse must have enough bone oldness.",
    "Horse needs skeleton growth in full enough.",
    "The horse requires more mature bones systemly."
  ],
  correctIndex: 0,
  explanation: "Najbardziej naturalna forma to: 'The horse needs enough skeletal maturity.'",
},
{
  id: 285,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Kostnienie kręgosłupa może trwać do 7–8 roku życia.'",
  options: [
    "Ossification of the spine may continue until 7–8.",
    "The spine bones may still make hard until seven or eight.",
    "Backbone hardening goes on to 7–8 years old horse.",
    "Spinal bone process can keep until 7 or 8ly."
  ],
  correctIndex: 0,
  explanation: "To poprawna forma ze słowniczka.",
},
{
  id: 286,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Praca z ziemi pomaga budować topline.'",
  options: [
    "Groundwork helps build the topline.",
    "Work from ground builds horse upper line.",
    "Ground horse work is helping the topline making.",
    "The topline gets made by floor training."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
{
  id: 287,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Rozpoczęcie pracy w wieku 4–5 lat może być bezpieczniejszym kompromisem.'",
  options: [
    "Starting at 4–5 can be a safer compromise.",
    "To start in 4 or 5 is more safe middle option.",
    "Beginning on age four-five can be safe compromise way.",
    "The safer middle point is starting horse around 4–5 age."
  ],
  correctIndex: 0,
  explanation: "To poprawne zdanie ze słowniczka.",
},
{
  id: 288,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Powtarzające się przeciążenie może prowadzić do urazów.'",
  options: [
    "Repetitive overload may cause injuries.",
    "Doing too much many times can make damages.",
    "Repeated hard work may go into horse hurts.",
    "Overload repeatedly can become injuries thing."
  ],
  correctIndex: 0,
  explanation: "Najbardziej naturalna forma to: 'Repetitive overload may cause injuries.'",
},
{
  id: 289,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Przetrenowanie może prowadzić do długofalowych problemów.'",
  options: [
    "Overtraining can lead to long-term problems.",
    "Too much training can go for problems in long.",
    "Overtraining makes issues over years time longly.",
    "Horse overwork may become future bad things."
  ],
  correctIndex: 0,
  explanation: "To naturalne i poprawne zdanie.",
},
{
  id: 290,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Kulawizna wymaga wezwania weterynarza.'",
  options: [
    "If there is lameness, call the vet.",
    "When horse limps you need animal doctor now.",
    "Lameness means phone the veterinarianly.",
    "If horse is lame you should call horse doctor direct."
  ],
  correctIndex: 0,
  explanation: "To poprawna forma podana w słowniczku.",
},
{
  id: 291,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Ból grzbietu może wyglądać jak opór albo brykanie.'",
  options: [
    "Back pain can look like resistance or bucking.",
    "The pain of back may seem like bad horse or kicks.",
    "Back hurt can show in resisting or horse jumping back legs.",
    "Pain in the back looks as no will or buck move things."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
{
  id: 292,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Weterynarz zalecił prześwietlenie.'",
  options: [
    "The vet recommended X-rays.",
    "The veterinarian said make bone photos.",
    "The vet told about doing a radiograph pictures.",
    "The doctor for animals recommended making skeleton checks."
  ],
  correctIndex: 0,
  explanation: "To poprawne i naturalne zdanie.",
},
{
  id: 293,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Siodło musi pasować do konia.'",
  options: [
    "The saddle must fit the horse.",
    "The saddle has to be same to the horse body.",
    "The horse needs a saddle of right shape fittingly.",
    "A saddle should match horse in correct way of body."
  ],
  correctIndex: 0,
  explanation: "To dokładnie naturalna forma ze słowniczka.",
},
{
  id: 294,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Dopasowanie siodła jest kluczowe dla młodych koni.'",
  options: [
    "Saddle fitting is crucial for young horses.",
    "Saddle fit is very key in young horse age.",
    "Young horses need the saddle fitting in important way.",
    "For young horses, fitting of saddle is one of crucial thingsly."
  ],
  correctIndex: 0,
  explanation: "To poprawne zdanie ze słowniczka.",
},
{
  id: 295,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Niedopasowany sprzęt powoduje dyskomfort i złe skojarzenia.'",
  options: [
    "Ill-fitting tack causes discomfort and bad associations.",
    "Wrong tack makes horse pain and poor mind links.",
    "Bad equipment fit gives discomfort and negative horse memory things.",
    "Poor tack fitting can build bad feelings and discomfort in the horse."
  ],
  correctIndex: 0,
  explanation: "To naturalna forma ze słowniczka.",
},
{
  id: 296,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Młode konie potrzebują częstszych wizyt kontrolnych.'",
  options: [
    "Young horses need more frequent check-ups.",
    "Young horses should have checking visits more oftenly.",
    "There must be more controls for young horses in frequency.",
    "The young horse needs repeated visits in more close time."
  ],
  correctIndex: 0,
  explanation: "To poprawne i naturalne zdanie.",
},
{
  id: 297,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Dłuższa rozgrzewka chroni grzbiet.'",
  options: [
    "A long warm-up protects the back.",
    "Long warming helps horse spine safety.",
    "A bigger warm-up keeps the back more protectedly.",
    "The back gets safe by long warming time."
  ],
  correctIndex: 0,
  explanation: "To naturalna forma ze słowniczka.",
},
{
  id: 298,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Zawsze uwzględniaj spokojne schłodzenie po pracy.'",
  options: [
    "Always include a calm cool-down.",
    "Always put a peaceful cooling after work.",
    "The horse must always have calm end-down after training.",
    "Include every time a quiet finish cooling process."
  ],
  correctIndex: 0,
  explanation: "To poprawna forma ze słowniczka.",
},
{
  id: 299,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'On jest gorący, ale da się go trenować.'",
  options: [
    "He’s hot but trainable.",
    "He is warm and possible in training.",
    "He gets heated but you can make training on him.",
    "He is strong energy horse but workable in trainingly."
  ],
  correctIndex: 0,
  explanation: "To gotowy zwrot ze słowniczka.",
},
{
  id: 300,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Napina się w nowym otoczeniu.'",
  options: [
    "He gets tense in new environments.",
    "He goes stiff in every new place around.",
    "In new areas he is making tension quickly.",
    "He becomes nervous in place changes new."
  ],
  correctIndex: 0,
  explanation: "To dokładnie naturalna forma ze słowniczka.",
},
{
  id: 301,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Jest chętny pracy, ale wrażliwy na łydkę.'",
  options: [
    "He’s forward, but sensitive to the leg.",
    "He goes ahead but leg makes him much feeling.",
    "He is front-going and easy on leg touching.",
    "He is willing to front but sensible by the calf aid."
  ],
  correctIndex: 0,
  explanation: "To gotowy zwrot ze słowniczka.",
},
{
  id: 302,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'On potrafi być natarczywy podczas pracy z ziemi.'",
  options: [
    "He can be pushy on the ground.",
    "He becomes dominant when standing near earth.",
    "On ground he can be too much moving into person.",
    "He may act push-like in hand work on floor."
  ],
  correctIndex: 0,
  explanation: "To poprawny i naturalny zwrot ze słowniczka.",
},
{
  id: 303,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Ona zawodowo uprawia ujeżdżanie.'",
  options: [
    "She rides dressage professionally.",
    "She does dressage in professional way riding.",
    "She is professionally on dressage rides.",
    "Her professional riding is in the dressage style."
  ],
  correctIndex: 0,
  explanation: "To gotowe zdanie ze słowniczka.",
},
{
  id: 304,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'My głównie jeździmy w terenie i robimy podstawową pracę na płasko.'",
  options: [
    "We mostly do hacking and basic schooling.",
    "We ride mostly outside and do basic horse training flatly.",
    "Mostly we are in trail and simple arena work.",
    "We go in field rides and plain riding schooling basic."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
{
  id: 305,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'On jest typu warmblood, hodowany do sportu.'",
  options: [
    "He’s a warmblood type, bred for sport.",
    "He is warmblood horse kind made to sport.",
    "This horse is sport warm breed style.",
    "He comes from warm blood and sport breeding use."
  ],
  correctIndex: 0,
  explanation: "To poprawna forma podana w słowniczku.",
},
{
  id: 306,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Użyli dolewu pełnej krwi, żeby dodać wytrzymałości i szlachetności.'",
  options: [
    "They used a Thoroughbred outcross to add stamina and refinement.",
    "They put thoroughbred blood to make more power and beauty.",
    "A full-blood cross was used for energy and finer shape.",
    "They crossed with TB to give more stamina and elegantness."
  ],
  correctIndex: 0,
  explanation: "To gotowe zdanie ze słowniczka.",
},
{
  id: 307,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'On ma długi grzbiet i nadal buduje siłę w topline.'",
  options: [
    "He’s long-backed and still building strength through the topline.",
    "He has a long back and is still making strength in upper line.",
    "The horse is long in back and builds topline power yet.",
    "He is long-backed and still growing strong on back line over."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
{
  id: 308,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Ona ma dobry zad, ale potrzebuje więcej równowagi w galopie.'",
  options: [
    "She has good hindquarters but needs more balance in the canter.",
    "She has a nice back end but needs better balance in gallop.",
    "Her hindquarters are good, but canter still misses balancing.",
    "She is strong behind but wants more canter balance thing."
  ],
  correctIndex: 0,
  explanation: "To poprawne i naturalne zdanie.",
},
{
  id: 309,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Używamy drągów, żeby poprawić rytm i koordynację.'",
  options: [
    "We use polework to improve rhythm and coordination.",
    "We use poles for making better rhythm and horse coordination.",
    "Pole working helps us with beat and body order.",
    "We do pole exercises to build timing and organized movemently."
  ],
  correctIndex: 0,
  explanation: "To gotowe zdanie ze słowniczka.",
},
{
  id: 310,
  type: "sentence",
  prompt: "Wybierz najlepsze zdanie: 'Praca z ziemi pomaga mu zrozumieć pomoce bez ciężaru jeźdźca.'",
  options: [
    "Groundwork helps him understand aids without a rider’s weight.",
    "Ground work lets him know signals with no rider heavy.",
    "He learns aids from ground when rider is not on his back.",
    "Without rider weight, groundwork gives understanding of helps."
  ],
  correctIndex: 0,
  explanation: "To naturalne zdanie ze słowniczka.",
},
